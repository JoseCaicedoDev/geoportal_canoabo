...
<template>
  <div class="w-96 bg-white shadow-xl border-r border-gray-200 flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto">
      <!-- Capas Base -->
      <div class="p-4">
        <h3 class="font-semibold text-geo-dark mb-3 flex items-center">
        ...
        <div class="space-y-2">
          ...
          <label class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
            <input
              ...
              class="text-geo-primary focus:ring-geo-primary"
            >
            <span class="text-sm">Calles</span>
          </label>
        </div>
      </div>
          ...
          <div class="border border-gray-200 rounded-lg">
            ...
            >
              <div class="flex items-center space-x-3">
                ...
                <span class="text-sm font-medium">Hidrología</span>
              </div>
              <i :class="[
            ...
            <div
              ...
              class="border-t border-gray-200 p-3 space-y-2 bg-gray-50"
            >
              <div class="flex items-center justify-between group">
                <label class="flex items-center space-x-3 cursor-pointer">
                  <input type="checkbox" class="text-geo-secondary focus:ring-geo-secondary">
                  <span class="text-sm">Río Canoabo</span>
                </label>
                <div class="relative">
                  <button
    ...
    <!-- Footer -->
    <footer class="bg-geo-dark text-white p-4 mt-auto">
      <div class="flex flex-col items-center space-y-3">
        <div class="flex items-center space-x-2">
          <p class="text-sm text-gray-300">© 2024 GeoCanoabo - Powered by Gira360</p>
        </div>
        <div class="flex items-center space-x-2">
          <i class="fab fa-leaflet text-geo-primary"></i>
          <span class="text-sm text-gray-300">Leaflet</span>
        </div>
        <div class="flex flex-wrap justify-center gap-x-4 gap-y-2">
          <button class="text-sm hover:text-geo-primary transition-colors">
